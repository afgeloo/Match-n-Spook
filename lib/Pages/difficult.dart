...
class DifficultPage extends StatefulWidget {
  const DifficultPage({Key? key}) : super(key: key);

  @override
  _DifficultPageState createState() => _DifficultPageState();
}
...
class _DifficultPageState extends State<DifficultPage> {
  List<String> imageAssets = [
    ...
    'characters/pics/jack.png',
    'characters/pics/mermaid.png',
  ];
  ...
  void initState() {
    ...
    // Set initial time to 2 minutes (60 seconds)
    secondsElapsed = 60;
  ...
  void startTimer() {
    const int totalSeconds = 60; // 2 minutes in seconds
      ...
      if (flippedIndices.length == 2) {
        ...
        if (gridImages[flippedIndices[0]] != gridImages[flippedIndices[1]]) {
          ...
          if (matchedIndices.isNotEmpty &&
              ...
              index % 4 != 0) {
            score += 200; // Add 100 points for streaks
          }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Image.asset(
          'assets/images/DifficultPage.png',
          height: 70,
        ),
        centerTitle: true,
